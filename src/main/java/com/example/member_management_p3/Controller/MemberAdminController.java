...
public class MemberAdminController {
  ...
  public String getAllMembers(Model model) {
    ...
    model.addAttribute("content", "/admin/member/members");
    return "/admin/admin";
  }
  ...
  public String deleteMembersByConditions(@ModelAttribute MemberDeleteCondition conditions, Model model) {
    ...
    String response = service.deleteMembersByConditions(conditions.getKhoa(), conditions.getNganh(),
        conditions.getMaTVSubstring());
  ...
  // public String addMultipleMembers(@RequestBody List<Member> members, Model
  // model) {
